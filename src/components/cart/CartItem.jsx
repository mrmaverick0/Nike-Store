...
const CartItem = ({
  item: { id, title, text, color, img, shadow, price, cartQuantity },
}) => {
  const dispatch = useDispatch();
  const onRemoveItem = () => {
    dispatch(
      cartActions.setRemoveItemFromCart({
        id,
        title,
        text,
        img,
  ...
  const onIncreaseItemQTY = () => {
    dispatch(
      cartActions.setIncreaseItemQTY({
        id,
        title,
        text,
        img,
  ...
  const onDecreaseItemQTY = () => {
    dispatch(
      cartActions.setDecreaseItemQTY({
        id,
        title,
        text,
        img,
      ...
      <div className="flex items-center justify-between w-full px-5">
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button
              type="button"
              className="bg-theme-cart rounded text-white font-medium lg:text-xs w-7 h-6 lg:h-5 lg:w-6 flex items-center justify-center cursor-pointer"
